  ...
  return (
    <div className="flex flex-col text-white rounded-2xl justify-center items-center">
      ...
      <div className="text-base w-full text-white rounded-lg">
        ...
        <input
          className="block file:bg-zinc-800 file:rounded-lg file:border-none file:p-1 w-full text-sm border rounded-lg cursor-pointer text-gray-400 focus:outline-none bg-zinc-900 border-gray-600"
          type="file"
...
const Signup = () => {
  return (
    <div className="w-full  flex items-center justify-center">
      <div className="w-full md:w-11/12 gap-5 flex-col md:flex-row flex h-fit p-2  bg-[#111518]  rounded-xl overflow-hidden">
